  ...
  return (
    <div>
      ...
      <div style={{display:'flex',justifyContent:'center',alignItems:'center',position:'relative'}}>
        <picture>
            <img style={{width:'800px',height:'1100px'}} src={HomePhoto.src} alt="Picture of the author" />
        </picture>
       <picture style={{position:'absolute',top:'86%'}}>
            <img  style={{width:'300px',height:'150px'}} src={PhoneView.src} alt="Picture of the author" />
        </picture>
      </div>
      <Footer/>
    </div>
